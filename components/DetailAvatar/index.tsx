    ...
    <div className="group transition-all hover:bg-white outer-circle">
      ...
      <div className="relative w-[160px] h-[160px]">
        <Image
          ...
          layout="fill"
        />
        <h3 className="absolute bottom-0 translate-y-2 text-center text-white group-hover:text-black capitalize font-emotion tracking-wider w-full transition-all mix-blend-color-dodge">
          {name}
        </h3>
      </div>
    </div>
